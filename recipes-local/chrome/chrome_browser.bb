...
do_install() {
	install -d ${D}/usr/bin ${D}/usr/share/applications ${D}/opt/google ${D}${sysconfdir}/tmpfiles.d ${D}/home/builder/.config/google-chrome/Default
	cp -rf ${S}/opt/* ${D}/opt/
	cp -rf ${S}/usr/* ${D}/usr/
	...
	cp ${WORKDIR}/Bookmarks ${D}/home/builder/.config/google-chrome/Default/Bookmarks
	cp ${WORKDIR}/Preferences ${D}/home/builder/.config/google-chrome/Default/Preferences 
}

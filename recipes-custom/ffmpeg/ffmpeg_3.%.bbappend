...
PACKAGECONFIG ??= "avdevice avfilter avcodec avformat swresample swscale bzlib gpl lzma libroxml librtmp libvorbis openssl theora x264 ${@bb.utils.contains('DISTRO_FEATURES', 'x11', 'x11 xv', '', d)}"
